...
self.addEventListener('push', (event) => {
    ...
    event.waitUntil(
        Promise.all([
            ...
            // Envoyer la métrique de réception
            ...
            }).catch(e => console.warn('[SW] Metrics error:', e)) : Promise.resolve()
        ])
    );
});
...
self.addEventListener('notificationclick', (event) => {
    ...
    event.waitUntil(
        Promise.all([
            ...
            }).catch(e => console.warn('[SW] Click metrics error:', e)) : Promise.resolve(),
