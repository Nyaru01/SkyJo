...
// banner. This worker activates immediately and reloads controlled windows so
// they receive the reliable update flow introduced in 3.3.x.
        ...
        self.clients.claim().then(async () => {
            ...
            await Promise.all(windows.map((client) => (
                client.navigate(client.url).catch((error) => {
                    console.warn('[SW] Migration reload failed:', error);
                })
            )));
        })
    );
