...
export default function MasterCareerPopup({ isOpen, onClose, onDiscover }) {
    return (
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
                    ...
                    <Motion.div initial={{ opacity: 0, scale: 0.94, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.96 }} className="relative w-full max-w-lg overflow-hidden rounded-[2.5rem] border border-fuchsia-400/30 bg-slate-950 p-8 text-center shadow-[0_0_80px_rgba(217,70,239,0.25)] md:p-11">
                        ...
                        <div className="relative">
                            ...
                            <p className="mb-3 text-[10px] font-black uppercase tracking-[0.35em] text-fuchsia-300">Niveau 100 atteint</p>
                            <h2 className="text-3xl font-black uppercase leading-tight text-white md:text-4xl">La Carrière Maître est débloquée</h2>
                            <p className="mx-auto mt-4 max-w-sm text-sm leading-relaxed text-slate-300">Cent nouveaux paliers, dix cosmétiques cosmiques et une boucle de Prestige infinie vous attendent.</p>
                            ...
                            <button onClick={onDiscover} className="h-14 w-full rounded-2xl border-b-4 border-fuchsia-900 bg-gradient-to-r from-fuchsia-600 to-violet-600 text-sm font-black uppercase tracking-[0.18em] text-white shadow-[0_12px_30px_rgba(192,38,211,0.3)] active:translate-y-0.5 active:border-b-2">Découvrir l’arbre</button>
