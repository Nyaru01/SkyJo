                                                                ...
                                                                {f.status === 'ACCEPTED' && (
                                                                    <div className="flex gap-1.5">
                                                                        ...
                                                                        <Button
                                                                            variant="ghost"
                                                                            size="sm"
                                                                            className="h-10 w-10 p-0 text-white bg-gradient-to-br from-skyjo-blue/80 to-indigo-500/80 hover:from-skyjo-blue hover:to-indigo-500 rounded-full shadow-lg shadow-skyjo-blue/20 transition-all active:scale-90"
                                                                            onClick={() => {
