...
const STEPS = [
    ...
    {
        title: "Historique Défausse 📜",
        description: "Vous avez un doute sur les cartes passées ? Faites un appui long sur la défausse pour voir les 4 dernières cartes jouées !",
        icon: Info,
        ...
        content: (
            <div className="flex flex-col items-center justify-center py-4 bg-slate-800/30 rounded-2xl border border-white/5 p-4">
                <div className="flex items-center gap-2 mb-2">
                    <div className="w-8 h-8 rounded-full bg-slate-700/50 animate-pulse border border-white/10 flex items-center justify-center">
                        <span className="text-[10px]">👆</span>
                    </div>
                    <span className="text-xs font-bold text-slate-400">Appui long...</span>
                </div>
