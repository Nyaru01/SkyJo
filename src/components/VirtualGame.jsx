                        ...
                        <div className="flex flex-col pt-2">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    { level: AI_DIFFICULTY.HARDCORE, label: 'Hardcore', color: 'from-red-600 to-rose-600', shadow: 'shadow-red-600/50', icon: Skull, desc: 'IA impitoyable' },
                                    { level: AI_DIFFICULTY.BONUS, label: 'Mode Bonus', color: 'from-purple-600 to-indigo-600', shadow: 'shadow-purple-600/50', icon: Gem, desc: 'Cartes funs' }
                                ].map((mode) => (
                                            ...
                                            >
                                                ...
                                                <Button
                                                    ...
                                                    className={`h-8 px-4 rounded-full text-[10px] font-black shadow-lg active:scale-95 transition-all ${friend.isOnline
                                                        ...
                                                        : 'bg-gradient-to-r from-skyjo-blue/80 to-indigo-500/80 hover:from-skyjo-blue hover:to-indigo-500 text-white shadow-skyjo-blue/20'
                                                        }`}
                                                    onClick={() => {
                                                        if (onlineRoomCode) {
        ...
        >
            ...
            {isInitialReveal && (
                <motion.div
                    ...
                    className="flex justify-center px-4 relative z-40 my-3"
                >
            ...
            <DrawDiscardPopup
                ...
                onDiscardDrawnCard={() => {
                    if (isBonusMode && activeGameState?.drawnCard?.value === 20) {
