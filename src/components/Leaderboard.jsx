...
export default function Leaderboard({ data, currentUserId, type, setType }) {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Podium */}
            {data.length > 0 && (
                <div className="flex items-end justify-center gap-4 pt-20 pb-10 px-2 bg-gradient-to-b from-skyjo-blue/10 to-transparent rounded-3xl border border-white/5 relative overflow-hidden shadow-2xl">
