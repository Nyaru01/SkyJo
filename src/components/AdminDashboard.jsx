...
import ColumnBeam from './virtual/ColumnBeam';
import SandboxBoard from './virtual/SandboxBoard';
    ...
    const renderContent = () => {
        ...
        return (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {/* MYSTERY CARD REVELATION TEST OVERLAY */}
                {showChestTest && (
                    <ChestRevelationOverlay
                        gameState={{
                            players: [
                                {
                                    id: 'test-p1', name: 'Joueur Test (Trésor)', hand: [{ id: 'c1', specialType: 'CH', value: 0 }]
                                },
                                {
                                    id: 'test-p2', name: 'Joueur Test (Piège)', hand: [{ id: 'c2', specialType: 'CH', value: 0 }]
                                }
                            ],
                            chestResults: { 'c1': -15, 'c2': 15 }
                        }}
                        onComplete={() => setShowChestTest(false)}
                    />
                )}
